...
This skill identifies all stakeholders relevant to a product initiative, maps their interests and influence, and produces a stakeholder management strategy that informs the PRD's communication and approval approach.
...
**1. Decision Makers**
People who must approve the initiative before work begins. They have budget authority, strategic oversight, or organisational accountability. Missing a decision maker means the PRD may be rejected after significant effort.
...
**2. Implementers**
People who will build, design, test, or deploy the initiative. Their feasibility assessment and effort estimates are critical inputs to the PRD.
...
- Typical roles: Customer Support (handles queries about it), Sales (sells it), Legal (assesses compliance), Finance (models revenue impact)
- Key question: "Whose work is indirectly affected by this initiative?"

**5. Influencers**
People who shape opinions about the initiative without having formal authority. They may advocate for or against the initiative informally.
...
| **Interest** | What they care about regarding this initiative (their primary concern) |
| **Influence** | High (can block or accelerate), Medium (can shape direction), Low (limited ability to affect outcome) |
| **Impact** | High (significantly affected by the outcome), Medium (moderately affected), Low (minimally affected) |
...
|---|-----------|-----------|
| **High Influence** | **Manage Closely:** Full engagement, regular updates, active collaboration on requirements | **Keep Satisfied:** Regular updates, address concerns promptly, do not over-burden with detail |
| **Low Influence** | **Keep Informed:** Periodic updates, solicit input on topics that affect them | **Monitor:** Occasional updates, available for questions |
...
- **Involvement points:** Which PRD stages require their input (e.g., requirements review, technical scoping, final approval)
...
4. Document the trade-off decision in the PRD for transparency
